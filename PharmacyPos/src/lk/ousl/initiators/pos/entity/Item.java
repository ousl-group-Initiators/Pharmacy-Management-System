...
public class Item {
    ...
    public Item(String item_id, String item_name,String item_code, Date manufacture_date, Date expire_date, int item_qty, Double unit_price, Double unit_discount, String supplier_id, String item_description){
